...
// [[stan::function]]
double
log_Z_com_poisson(const double& log_mu, const double& nu) {
...
PYBIND11_MODULE(comp_Z_brms_fixed, m)
{
  ...
  m.doc() = "comp_Z_brms_fixed.stan functions";

  m.def("log_Z_com_poisson_approx", &log_Z_com_poisson_approx, py::arg("log_mu"), py::arg("nu"), py::call_guard<py::scoped_ostream_redirect, py::scoped_estream_redirect>());
  m.def("log_Z_com_poisson", &log_Z_com_poisson, py::arg("log_mu"), py::arg("nu"), py::call_guard<py::scoped_ostream_redirect, py::scoped_estream_redirect>());
  m.def("com_poisson_log_lpmf", &com_poisson_log_lpmf, py::arg("y"), py::arg("log_mu"), py::arg("nu"), py::call_guard<py::scoped_ostream_redirect, py::scoped_estream_redirect>());
  m.def("com_poisson_lpmf", &com_poisson_lpmf, py::arg("y"), py::arg("mu"), py::arg("nu"), py::call_guard<py::scoped_ostream_redirect, py::scoped_estream_redirect>());
  m.def("com_poisson_lcdf", &com_poisson_lcdf, py::arg("y"), py::arg("mu"), py::arg("nu"), py::call_guard<py::scoped_ostream_redirect, py::scoped_estream_redirect>());
  m.def("com_poisson_lccdf", &com_poisson_lccdf, py::arg("y"), py::arg("mu"), py::arg("nu"), py::call_guard<py::scoped_ostream_redirect, py::scoped_estream_redirect>());
}
