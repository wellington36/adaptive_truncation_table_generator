functions {
  int log_Z_iterations_brute(real log_lambda, real nu, int M, real eps) {
    real log_Z;
    real log_Z_true;
    int k = 2;
    real leps = log(eps);
  ...
  real log_Z_value_brute(real log_lambda, real nu, int M, real eps) {
    real log_Z;
    real log_Z_true;
    int k = 2;
    real leps = log(eps);
  ...
  real log_Z_brute(real log_lambda, real nu, int M) {
    real log_Z;
    int k = 2;
    vector[M] log_Z_terms;
